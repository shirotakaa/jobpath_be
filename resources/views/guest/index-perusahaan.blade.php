                ...
                <div class="header-left">
                    <div class="header-logo">
                        <a href="{{ route('guest.index') }}" class="d-flex" style="width: 138px; height: 43px;">
                            <img src="{{ Storage::url($identitas->logo_dark) }}" alt="JobPath"
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="block-signin mt-3 d-flex align-items-center mobile-wrap">
                    <a href="{{ route('login-perusahaan') }}" class="btn btn-default btn-shadow me-2 hover-up">Login</a>
                        ...
                        <div class="col-lg-5 d-none d-lg-block">
                            <div class="banner-imgs" style="height: 462px;">
                                <img
                                    ...
                                    alt="JobPath" width="100%" height="100%" style="object-fit: cover;" />
                        ...
                        <div class="card-grid-4 hover-up">
                            <div class="image-top-feature">
                                <figure class="w-100 h-100 m-0">
                                    <img src="assets/user/imgs/icons/{{ $f['icon'] }}" class="w-100 h-100 object-fit-cover" alt="Icon" />
                                </figure>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="content-job-inner">
                            ...
                            <div class="mt-40 pr-50 text-md-lh28 wow animate__animated animate__fadeInUp">
                                Pasang lowongan gratis, jangkau lebih banyak kandidat, dan kelola rekrutmen lebih efisien.
                            </div>
                            <div class="mt-40">
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="{{ route('guest.index') }}">
                        <img src="{{ Storage::url($identitas->logo_dark) }}" style="width: 134px; height: 43px; object-fit: cover;" alt="JobPath" />
                    </a>

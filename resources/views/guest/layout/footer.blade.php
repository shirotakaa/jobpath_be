                        ...
                        <div class="footer-bottom footer-bottom-sosial mt-50">
                            <div class="footer-social text-left">
                                @if (!empty($identitas->facebook))
                                    <a href="{{ $identitas->facebook }}" class="icon-socials icon-facebook" target="_blank"></a>
                                @endif
                                @if (!empty($identitas->instagram))
                                    <a href="{{ $identitas->instagram }}" class="icon-socials icon-instagram" target="_blank"></a>
                                @endif

                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div>
                                        <!-- Tombol-tombol export dan fitur tambahan tabel -->
                                        ...
                                        <button class="btn btn-light-primary dropdown-toggle" id="colVisBtn"
                                            data-bs-toggle="dropdown">Column Visibility</button>
                                        ...
                                        @foreach($perusahaan as $index => $item)
                                            <tr>
                                                ...
                                                <td class="text-end text-nowrap">
                                                    <!-- Tombol edit: membuka modal dan mengisi data -->
                                                    <button type="button"

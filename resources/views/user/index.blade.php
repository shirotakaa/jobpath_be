                        ...
                        @foreach ($kategoriPekerjaan as $kategori)
                            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card-grid hover-up wow animate__animated animate__fadeInUp" 
                                     ...
                                     onclick="searchByCategory('{{ $kategori['nama'] }}')" 
                            ...
                            <div class="card-grid hover-up wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="text-center mt-30">
                                    <div class="box-button-shadow">
                                        <a href="{{ route('daftar-pekerjaan') }}" class="btn btn-default">Jelajahi lebih lanjut</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 text-xl-end text-start">
                            <ul class="nav nav-right float-xl-end float-start" role="tablist">
                                @foreach($categories as $index => $category)
                                    <li>
                                        <button id="nav-tab-{{ $index }}" data-bs-toggle="tab"
                                                    ...
                                                    <div class="card-block-info">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-12"
                                                                ...
                                                                <a href="{{ route('daftar-pekerjaan', $job->id_pekerjaan) }}"
                                                        ...
                                                        <div class="mt-15" style="display: flex; gap: 24px;">
                                                            <a href="#">
                                                                <span class="text-brand-10 text-icon-first">{{ $job->perusahaan->nama_perusahaan }}</span>
                                                            </a>
                                                        ...
                                                        <div class="card-2-bottom mt-30">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-4">
                                                                    <span class="card-text-price"> {{ $job->rentang_gaji }} </span>
                                                                </div>

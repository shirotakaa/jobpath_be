        ...
        <section class="section-box">
            <div class="container pt-50">
                <div class="w-50 w-md-100 mx-auto text-center">
                    ...
                    <p class="mb-30 text-muted wow animate__animated animate__fadeInUp font-md">Cek pertanyaan yang sering
                        diajukan di sini sebelum menghubungi kami. Berikut beberapa masalah umum yang mungkin Anda temui
                        saat menggunakan sistem kami.</p>
                </div>
            </div>
        </section>
